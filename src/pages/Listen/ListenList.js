// src/pages/Listen/ListenList.jsx
      ...
      <Row className="mb-3 align-items-center">
        ...
        <Col md={7}>
          <div className="d-flex justify-content-end">
            <Link
              to={`/dashboard/add-listen/${celebrityId}`}
...
const ListenList = () => {
  ...
  const [listenList, setListenList] =
    useState([]);
...

    {
      ...
      Cell: ({ row }) => {
        return (
          <div className="d-flex gap-2">
            <Link
              to={`/dashboard/update-listen/${row.original._id}`}
